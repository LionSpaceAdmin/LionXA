...
exports.config = {
    ...
    browser: {
        ...
        userDataDir: process.env.BROWSER_USER_DATA_DIR || path_1.default.resolve(process.cwd(), 'src/agent/.agent_chromium_profile'),
    ...
    agent: {
        ...
        security: {
            ...
            backupPath: process.env.BACKUP_PATH || path_1.default.resolve(process.cwd(), 'src/agent/backups')
        },
        rateLimit: {
