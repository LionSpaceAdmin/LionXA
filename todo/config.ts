...
// Load environment variables from the Xagent project root
...
export const config = {
  ...
  browser: {
    ...
    userDataDir: process.env.BROWSER_USER_DATA_DIR || path.resolve(process.cwd(), 'Xagent/.agent_chromium_profile'),
